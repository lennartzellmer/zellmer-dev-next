<template>
  ...
  >
    ...
    <article
      class="z-10 mt-6 mb-3 w-full rounded-r-lg transition-all sm:py-8 sm:pr-10 sm:group-hover:pr-6 sm:group-focus:pr-6 sm:pl-8 sm:group-hover:pl-8 sm:group-focus:pl-8 sm:mt-3 sm:group-hover:bg-slate-3 sm:group-focus:bg-gray-100"
    >
